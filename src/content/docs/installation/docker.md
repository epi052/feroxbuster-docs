...
You've got some options available if you want to pass in a config file. [ferox-config.toml](/feroxbuster-docs/configuration/ferox-config-toml/) can live in multiple locations and still be valid, so it's up to you how you'd like to pass it in. Below are a few valid examples:
