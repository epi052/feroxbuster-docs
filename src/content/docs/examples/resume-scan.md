...
description: Added in version **1.9.0** updated in **2.8.0**
---
...
![save-state](/feroxbuster-docs/images/examples/save-state.png)
...
![resumed-scan](/feroxbuster-docs/images/examples/resumed-scan.gif)
