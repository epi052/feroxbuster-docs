---
title: Extract Links
description: Added in version **1.1.0**
---
...
![normal-scan-cmp-extract](/feroxbuster-docs/images/examples/normal-scan-cmp-extract.gif)

### With `--extract-links`

![extract-scan-cmp-normal](/feroxbuster-docs/images/examples/extract-scan-cmp-normal.gif)
